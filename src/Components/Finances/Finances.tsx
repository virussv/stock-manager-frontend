			...
			<main className='animeTop' ref={mainRef}>
				<section className={`${styles.finances}`}>
					<div className={styles.headerComponent}>
						<div><ButtonAdd onClick={({target}:SyntheticEvent) => handleClickModal(target,setEnterModal,setActiveModal)} id={styles.addTransaction} label={'Adicionar transação'} htmlFor={styles.addTransaction} refButton={buttonRef}/></div>
						<div className={styles.payments}><Link to={'/pagamentos'}>Pagar/Receber</Link></div>
					</div>
