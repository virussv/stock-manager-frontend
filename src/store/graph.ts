...
true and after 500ms I change it to false the redux state works much better in exchanging components/values 
​​with input animations, because when I use a react state as a dependency in useEffect, the useEffect is triggered, 
